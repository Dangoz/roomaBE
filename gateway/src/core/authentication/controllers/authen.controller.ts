...
class AuthenController implements IController {
  ...
  private authenticate = async (req: Request, res: Response) => {
    ...
    const { age, phone, pronouns, preference, interests, occupation, school } = req.user;
    const user: IUserProfile = { ...userViewModel, age, phone, pronouns, preference, interests, occupation, school };
